...
namespace BlingLuxury.Clases
{
    public class Producto
    {
        ...
        public Producto(int id, string codigoDeBarras, double peso, string descripcion,
        ...
        public Producto(string codigoDeBarras, double peso, string descripcion, Modelo id_modelo,
        ...
        public Producto(int id, double peso, string descripcion, Modelo id_modelo, PrecioAdquisicion id_precio_adquisicion, Color id_color, 
                        Categoria id_categoria)
        {
            this.id = id;
            this.peso = peso;
        ...
        public Producto(double peso, string descripcion, Modelo id_modelo, PrecioAdquisicion id_precio_adquisicion, Color id_color, Categoria id_categoria)
        {
            this.peso = peso;
            this.descripcion = descripcion;
            this.id_modelo = id_modelo;
