                    ...
                    using (reader = cmd.ExecuteReader())
                    {
                        if (reader.HasRows)
                        {
                            while (reader.Read())
                            {
                                ...
                                string codigoProducto = reader.GetString(1);
                                double pesoProducto = reader.GetDouble(2);
                                Modelo productoIdModelo = new Modelo(reader.GetString(3));
                                Marca modeloIdMarca = new Marca(reader.GetString(4));
                                PrecioAdquisicion productoIdPrecio_adquisicion = new PrecioAdquisicion(reader.GetDouble(5));
                                Color productoIdColor = new Color(reader.GetString(6));
                                Categoria productoIdCategoria = new Categoria(reader.GetString(7));
